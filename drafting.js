const margin = 30;
    ...
    function formatLength(length) {
      ...
      console.log(inches, " ", closestFraction.display);
    };
    ...
    const steps = [
        ...
        {
            description: `B to D is 1/12 breast (${formatLength(document.getElementById('breast').value / 12)} inches)(${formatLength(25 / 12)} inches)`,
            action: (ctx) => {
